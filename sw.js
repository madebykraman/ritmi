const CACHE='ritmi-shell-v5';
const ASSETS=['./','./index.html','./manifest.webmanifest','./sw.js','./icon.svg','./ritmi-addon.js','./ritmi-storage-v4.js','./ritmi-storage-controls-v4.js','./ritmi-community-v1.js','./community-feed.json'];
